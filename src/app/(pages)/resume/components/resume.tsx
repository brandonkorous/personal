                        ...
                        <section className="mb-12">
                            ...
                            <div className="mb-10">
                                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-3">
                                    ...
                                    <div className="badge badge-secondary mt-2 md:mt-0 text-nowrap">
                                        August 2023 – Present
                                    </div>
                                </div>
                            ...
                            <div className="mb-10">
                                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-3">
                                    <div>
                                        <h5 className="text-xl  text-neutral">Partner – Chief Technology Officer (CTO)</h5>
                        ...
                        <section className="mb-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p>Azure, AWS, DigitalOcean, Cloudflare, Salesforce, Snowflake</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p>Bootstrap, DaisyUI, TailwindCSS, MaterialUI, SCSS, FontAwesome, Lucid</p>
                                </div>
                                <div>
                                    <h5 className=" text-secondary">AI & Automation</h5>
                                    <p>OpenAI, Azure OpenAI, Azure Cognitive Services, Intelligent Process Automation</p>
                                </div>
                                <div>
                                    <h5 className=" text-secondary">Security & Compliance</h5>
                                    <p>OAuth2, JWT, Zero Trust Architecture, DevSecOps, MFA, HIPAA, PCI DSS, DOJ, NYDFS, CCPA</p>
                                </div>
                                <div>
                                    <h5 className=" text-secondary">Data & Analytics</h5>
                                    <p>SQL Server, Snowflake, MySQL, PostgreSQL, SSRS, PowerBI </p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p>Microsoft Teams, Salesforce, Zoom, Slack, GSuite, Figma, Miro, monday.com</p>
                                </div>
                                <div>
                                    <h5 className=" text-secondary">Project & Process Frameworks</h5>
                                    <p>Agile, Scrum, Kanban, Architecture Review Boards, Hackathons</p>
                                </div>
                            </div>
                        </section>
